...
@section('content')
    ...
    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="bg-gray-800 p-6 rounded-lg shadow-md max-w-xl mx-auto">
        @csrf
        ...
        <div class="mb-4">
            <label for="images" class="block text-gray-300">Upload Images</label>
            <input type="file" name="images[]" id="images" class="w-full border-gray-600 bg-gray-700 text-white rounded-md shadow-sm" multiple>
